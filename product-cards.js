const catalogProducts = [
    {
        altAlert: " it's an ak101 assault rifle",
    ...
    {
        altAlert: " it's an ak12 assault rifle",
    ...
    {
        altAlert: " it's an ak74 assault rifle",
    ...
    {
        altAlert: " it's an akm assault rifle",
            ...
            <div class="catalog-product">
                ...
                <div class="product-actions">
                    <span class="product-quantity-container">
                        ...
                        <button class="product-add-button" disabled> ADD </button>
                    </span>
                </div>
            </div>
        </div>`            
